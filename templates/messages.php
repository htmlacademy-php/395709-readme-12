    ...
    if ( ! empty($messageAuthor)) { ?>
        <section class="messages tabs">
                ...
                <ul class="messages__contacts-list tabs__list">
                    ...
                    foreach ($messageAuthor as $author) { ?>
                        <li class="messages__contacts-item">
                            <a href=http://395709-readme-12/messages.php?id=<?= $author['authorId'] == $_SESSION['id'] ? $author['recipientId'] : $author['authorId'] ?> >
                                <div class="messages__contacts-tab <?= ($author['authorId'] == $_SESSION['id'] ? $author['recipientId'] : $author['authorId']) == $_GET['id'] || $i == 0 ? 'messages__contacts-tab--active' : '' ?>   ">
            ...
            <div class="messages__chat">
                ...
                <div class="comments">
                    <form class="comments__form form" action="../messages.php?id=<?= htmlspecialchars($_GET['id']) ?>"
                          method="post">
