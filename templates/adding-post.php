        ...
        <div class="header__nav-wrapper">
          <nav class="header__nav">
            ...
            <ul class="header__user-nav">
              ...
              <li>
                <a class="header__post-button header__post-button--active button button--transparent" href="http://395709-readme-12/">Закрыть</a>
              </li>
            </ul>
          </nav>
        </div>
          ...
          <div class="adding-post__tabs-wrapper tabs">
            ...
            <div class="adding-post__tab-content">
              <section class="adding-post__photo tabs__content  <?= ($type==0 or $type==1) ? " tabs__content--active" : ""?> ">
                ...
                <form class="adding-post__form form" action="add.php" method="post" name="addPhoto" enctype="multipart/form-data" id = 1>
              ...
              <section class="adding-post__text tabs__content  <?= $type==3 ? " tabs__content--active" : ""?> ">
              ...
              <section class="adding-post__quote tabs__content  <?= $type==4 ? " tabs__content--active" : ""?> ">
                    ...
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <input type="hidden" name="name" value="4">
                          <input class="adding-post__input form__input" id="quote-heading" type="text" name="quote-heading" value="<?=getPostVal('quote-heading')?>"  placeholder="Введите заголовок">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                    ...
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <input type="hidden" name="name" value="5">
                          <input class="adding-post__input form__input" id="link-heading" type="text" name="link-heading" value="<?=getPostVal('link-heading')?>"  placeholder="Введите заголовок">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
